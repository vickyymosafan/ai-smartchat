...
import { LyricsModal } from "@/components/dialogs/lyrics-modal"
...
export function MusicPlayer() {
  ...
  const hasLyrics = currentTrack?.lyrics || playlist.some((t) => t.lyrics)
  ...
  return (
    <>
      ...
      {/* Lyrics Modal */}
      <LyricsModal open={showLyrics} onClose={() => setShowLyrics(false)} track={lyricsTrack} />
    </>
  )
}
